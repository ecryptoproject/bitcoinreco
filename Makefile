...
pkgdatadir = $(datadir)/bitcoinreco
pkgincludedir = $(includedir)/bitcoinreco
pkglibdir = $(libdir)/bitcoinreco
pkglibexecdir = $(libexecdir)/bitcoinreco
...
CONFIG_HEADER = $(top_builddir)/src/config/bitcoinreco-config.h
CONFIG_CLEAN_FILES = libbitcoinrecoconsensus.pc share/setup.nsi \
...
CONFIG_CLEAN_VPATH_FILES = contrib/filter-lcov.py \
	...
	test/util/bitcoinreco-util-test.py test/util/rpcauth-test.py
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libbitcoinrecoconsensus.pc.in \
	...
	$(top_srcdir)/src/config/bitcoinreco-config.h.in \
	$(top_srcdir)/test/config.ini.in \
	$(top_srcdir)/test/functional/test_runner.py \
	$(top_srcdir)/test/util/bitcoinreco-util-test.py \
...
ACLOCAL = ${SHELL} /home/cadkas/Desktop/bitcoinreco/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/cadkas/Desktop/bitcoinreco/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/cadkas/Desktop/bitcoinreco/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/cadkas/Desktop/bitcoinreco/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOINRECO_CLI_NAME = bitcoinreco-cli
BITCOINRECO_DAEMON_NAME = bitcoinrecod
BITCOINRECO_GUI_NAME = bitcoinreco-qt
BITCOINRECO_TX_NAME = bitcoinreco-tx
...
COPYRIGHT_HOLDERS_FINAL = The Bitcoinreco developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Bitcoinreco
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/cadkas/Desktop/bitcoinreco/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = bitcoinreco
PACKAGE_BUGREPORT = https://github.com/cadkas/bitcoinreco/issues
PACKAGE_NAME = Bitcoinreco Core
PACKAGE_STRING = Bitcoinreco Core 0.16.99
PACKAGE_TARNAME = bitcoinreco
PACKAGE_URL = https://bitcoinreco.com/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/cadkas/Desktop/bitcoinreco
abs_srcdir = /home/cadkas/Desktop/bitcoinreco
abs_top_builddir = /home/cadkas/Desktop/bitcoinreco
abs_top_srcdir = /home/cadkas/Desktop/bitcoinreco
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/cadkas/Desktop/bitcoinreco/build-aux/install-sh
...
pkgconfig_DATA = libbitcoinrecoconsensus.pc
BITCOINRECOD_BIN = $(top_builddir)/src/$(BITCOINRECO_DAEMON_NAME)$(EXEEXT)
BITCOINRECO_QT_BIN = $(top_builddir)/src/qt/$(BITCOINRECO_GUI_NAME)$(EXEEXT)
BITCOINRECO_CLI_BIN = $(top_builddir)/src/$(BITCOINRECO_CLI_NAME)$(EXEEXT)
BITCOINRECO_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = Bitcoinreco-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/bitcoinreco.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/bitcoinreco-cli.bash-completion \
	       $(top_srcdir)/contrib/bitcoinreco-tx.bash-completion \
	       $(top_srcdir)/contrib/bitcoinrecod.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/bitcoinreco.ico \
...
COVERAGE_INFO = baseline.info \
  test_bitcoinreco_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_bitcoinreco_coverage.info test_bitcoinreco.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoinreco.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Bitcoinreco-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
EXTRA_DIST = $(DIST_SHARE) test/functional/test_runner.py \
	...
	test/util/bitcoinreco-util-test.py \
	test/util/data/bitcoinreco-util-test.json \
...
CLEANFILES = $(OSX_DMG) $(BITCOINRECO_WIN_INSTALLER)
...
src/config/bitcoinreco-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/bitcoinreco-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/bitcoinreco-config.h
$(top_srcdir)/src/config/bitcoinreco-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/bitcoinreco-config.h src/config/stamp-h1
libbitcoinrecoconsensus.pc: $(top_builddir)/config.status $(srcdir)/libbitcoinrecoconsensus.pc.in
...
$(BITCOINRECO_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITCOINRECOD_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITCOINRECO_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITCOINRECO_CLI_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/bitcoinreco.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Bitcoinreco-Qt: $(BITCOINRECO_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Bitcoinreco-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Bitcoinreco-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#deploy: $(OSX_DMG)
#deploy: $(BITCOINRECO_WIN_INSTALLER)

$(BITCOINRECO_QT_BIN): FORCE
	$(MAKE) -C src qt/$(@F)

$(BITCOINRECOD_BIN): FORCE
	$(MAKE) -C src $(@F)

$(BITCOINRECO_CLI_BIN): FORCE
	$(MAKE) -C src $(@F)
...
#test_bitcoinreco.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_bitcoinreco -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_bitcoinreco_filtered.info: test_bitcoinreco.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_bitcoinreco_filtered.info
...
#test_bitcoinreco_coverage.info: baseline_filtered.info test_bitcoinreco_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_bitcoinreco_filtered.info -o $@

#total_coverage.info: test_bitcoinreco_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_bitcoinreco_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_bitcoinreco.coverage/.dirstamp:  test_bitcoinreco_coverage.info
...
#cov: test_bitcoinreco.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_bitcoinreco.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP) src/qt/moc_*
