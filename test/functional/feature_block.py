...
class FullBlockTest(BitcoinrecoTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bitcoinrecod isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitcoinrecod isn't accepting b28
        ...
        # bitcoinrecod doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bitcoinreco code has custom code which does so);
