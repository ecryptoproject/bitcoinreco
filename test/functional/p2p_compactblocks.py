...
# TestP2PConn: A peer we use to send messages to bitcoinrecod, and store responses.
...
class CompactBlocksTest(BitcoinrecoTestFramework):
    ...
    # This test actually causes bitcoinrecod to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinrecod's choice of nonce.
    ...
    # Test that bitcoinrecod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinrecod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinrecod will not send blocktxn responses for blocks whose height is
