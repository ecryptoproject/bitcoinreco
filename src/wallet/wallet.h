...
#ifndef BITCOINRECO_WALLET_WALLET_H
#define BITCOINRECO_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinreco node, and set to 0 for transactions that were created
...
#endif // BITCOINRECO_WALLET_WALLET_H
