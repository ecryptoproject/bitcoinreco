...
#ifndef BITCOINRECO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINRECO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINRECO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
