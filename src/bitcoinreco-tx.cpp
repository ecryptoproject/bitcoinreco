...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf(_("%s bitcoinreco-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinreco-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinreco transaction") + "\n" +
              "  bitcoinreco-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinreco transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinreco transaction
