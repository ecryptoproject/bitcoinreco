...
#ifndef BITCOINRECO_TEST_SCRIPTNUM10_H
#define BITCOINRECO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoinreco Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRECO_TEST_BIGNUM_H
