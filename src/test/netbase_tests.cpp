...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinreco.org", "www.bitcoinreco.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinreco.org]", "www.bitcoinreco.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinreco.org:80", "www.bitcoinreco.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinreco.org]:80", "www.bitcoinreco.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6523", "127.0.0.1", 6523));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6523", "127.0.0.1", 6523));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6523", "::ffff:127.0.0.1", 6523));
    BOOST_CHECK(TestSplitHost("[::]:6523", "::", 6523));
    BOOST_CHECK(TestSplitHost("::6523", "::6523", -1));
    BOOST_CHECK(TestSplitHost(":6523", "", 6523));
    BOOST_CHECK(TestSplitHost("[]:6523", "", 6523));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6523", "127.0.0.1:6523"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6523", "[::]:6523"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
