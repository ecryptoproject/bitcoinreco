// Copyright (c) 2018 The Bitcoinreco Core developers
...
/*        result.txout_address_is_mine.emplace_back(ExtractDestination(txout.scriptPubKey, result.txout_address.back()) ?
        ...
        result.txout_address_is_mine.emplace_back(ExtractDestination2Keys(txout.scriptPubKey, txout.receiverPubKey, result.txout_address.back()) ?
                                                      IsMine(wallet, result.txout_address.back()) :
                                                      ISMINE_NO);
    }
    ...
    for (unsigned int nOut = 0; nOut < result.tx->vout.size(); nOut++)
    {
        ...
        if (txout.referenceline!=""){ 
            result.reflines.push_back(wtx.DecryptRefLine2PubKeys(txout.referenceline,txout.senderPubKey,txout.receiverPubKey));
...
public:
    ...
    std::string DecryptRefLine2PubKeys(std::string referenceline,CPubKey pubkey1,CPubKey pubkey2) override { return m_wallet.DecryptRefLine2PubKeys(referenceline, pubkey1, pubkey2); }
