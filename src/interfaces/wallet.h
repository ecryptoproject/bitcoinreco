...
#ifndef BITCOINRECO_INTERFACES_WALLET_H
#define BITCOINRECO_INTERFACES_WALLET_H
...
public:
    ...
    virtual std::string DecryptRefLine2PubKeys(std::string referenceline,CPubKey pubkey1,CPubKey pubkey2)=0;
...
#endif // BITCOINRECO_INTERFACES_WALLET_H
