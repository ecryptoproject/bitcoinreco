...
#ifndef BITCOINRECO_INTERFACES_NODE_H
#define BITCOINRECO_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinreco node (bitcoinrecod process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINRECO_INTERFACES_NODE_H
