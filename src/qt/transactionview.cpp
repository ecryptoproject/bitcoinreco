...
void TransactionView::changedAmount()
{
    ...
    if (BitcoinrecoUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(tr("Reference line"), 0, TransactionTableModel::ReferencelineRole);
    writer.addColumn(BitcoinrecoUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
