...
#ifndef BITCOINRECO_QT_BITCOINRECOUNITS_H
#define BITCOINRECO_QT_BITCOINRECOUNITS_H
...
/** Bitcoinreco unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinrecoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinrecoUnits(QObject *parent);

    /** Bitcoinreco units.
      @note Source: https://en.bitcoinreco.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BREC,
...
typedef BitcoinrecoUnits::Unit BitcoinrecoUnit;

#endif // BITCOINRECO_QT_BITCOINRECOUNITS_H
