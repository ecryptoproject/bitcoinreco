...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitcoinrecoAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bitcoinreco-qt -platform xcb      # Linux
//     src/qt/test/test_bitcoinreco-qt -platform windows  # Windows
//     src/qt/test/test_bitcoinreco-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = BitcoinrecoUnits::formatWithUnit(unit, balance, false, BitcoinrecoUnits::separatorAlways);
    ...
    // Amount input
    BitcoinrecoAmountField* amountInput = receiveCoinsDialog.findChild<BitcoinrecoAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bitcoinreco:")) != -1);
