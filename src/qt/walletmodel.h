...
#ifndef BITCOINRECO_QT_WALLETMODEL_H
#define BITCOINRECO_QT_WALLETMODEL_H
...
/** Interface to Bitcoinreco wallet from Qt view code. */
...
#endif // BITCOINRECO_QT_WALLETMODEL_H
