...
#ifndef BITCOINRECO_QT_SPLASHSCREEN_H
#define BITCOINRECO_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Bitcoinreco Core initialization
...
#endif // BITCOINRECO_QT_SPLASHSCREEN_H
