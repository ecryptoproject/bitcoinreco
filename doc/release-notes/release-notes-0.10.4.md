Bitcoinreco Core version 0.10.4 is now available from:

  <https://bitcoinreco.org/bin/bitcoinreco-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinreco-tx into its own package
- #6953 `dfe0d4d` Include bitcoinreco-tx binary on Debian/Ubuntu
