Bitcoinreco version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinreco/files/Bitcoinreco/bitcoinreco-0.5.4/
...
http://gitorious.org/bitcoinreco/bitcoinrecod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoinreco-Qt notifications under Growl 1.3.
Increase required age of Bitcoinreco-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinreco properly when installing Bitcoinreco-Qt over it. (Windows)
