Bitcoinreco-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinreco/files/Bitcoinreco/bitcoinreco-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoinreco
...
New/changed settings (command-line or bitcoinreco.conf file)
--------------------------------------------------------
