Bitcoinreco Core version 0.9.4 is now available from:

  https://bitcoinreco.org/bin/0.9.4/
...
this update is incompatible with the Bitcoinreco system and could lead to consensus
forks.

Bitcoinreco Core released binaries from https://bitcoinreco.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinreco/+archive/ubuntu/bitcoinreco
- A third-party or self-compiled Bitcoinreco Core

upgrade to Bitcoinreco Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
