Download URL: https://sourceforge.net/projects/bitcoinreco/files/Bitcoinreco/bitcoinreco-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BREC fee schedule (users still pay 0.01 BREC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinreco00 - #bitcoinreco99
