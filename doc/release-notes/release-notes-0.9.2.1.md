Bitcoinreco Core version 0.9.2.1 is now available from:

  https://bitcoinreco.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BREC to 0.01 BREC
...
- Fix "Start bitcoinreco on system login"
