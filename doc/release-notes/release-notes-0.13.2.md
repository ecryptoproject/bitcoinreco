Bitcoinreco Core version 0.13.2 is now available from:

  <https://bitcoinreco.org/bin/bitcoinreco-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinreco-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinreco-tx to create v2 transactions (btcdrak)
