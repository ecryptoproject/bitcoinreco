...
This document provides guidelines for internationalization of the Bitcoinreco Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Bitcoinreco network</numerusform>
            <numerusform>%n active connections to Bitcoinreco network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinreco_en.ts` remains unchanged.
